...
const Card: React.FC<Partial<PoolData>> = ({
  ...
  return (
    <div className="bg-[#1414]  text-gray-300 rounded-md md:w-[350px] w-full  ">
      ...
      <div className="flex flex-col gap-4 px-2  py-2 w- font-leagueSpartan">
        <div className="flex flex-row gap-12">
          <div className="flex flex-col w-full">
            <h3 className=" whitespace-nowrap">
              Trading Fee Rate
            </h3>
            <p className="text-gray-100 text-xl font-semibold">{tradingFeeRate}</p>
          </div>
          <div className="flex  flex-col w-full">
            <h3 className=" whitespace-nowrap">TVL</h3>
            <p className="text-gray-100 text-xl font-semibold ">${historicalData.tvl[0].value} K</p>
          </div>
        </div>
        <div className="flex  flex-row  gap-12 ">
          <div className=" flex flex-col w-full ">
            ...
            <p className="text-gray-100 text-xl font-semibold">{volatilityCoefficient}</p>
          </div>
          <div className=" flex flex-col w-full">
            <h3 className="  whitespace-nowrap">Volume 24H</h3>
            <p className="text-gray-100 text-xl font-semibold">{volume24h}</p>
          </div>
        </div>
      </div>
    </div>
