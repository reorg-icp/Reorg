import BlogSection, { Article } from "./BlogSection";
...
function BlogsPosts() {
  ...
  return (
    <div className="bg-[#1A2240] rounded border border-transparent w-full mt-24 ">
      <div className="py-8 px-4 mx-auto max-w-screen-xl  lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center  mb-4">
          <h2 className="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
            Our Blogs
          </h2>
          <p className="font-light  sm:text-xl font-leagueSpartan text-gray-400  text-center">
...
<section className="mt-4 ">
  <div className="py-8 px-4 mx-auto max-w-screen-xl  lg:px-6">
      <div className="mx-auto max-w-screen-md sm:text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl  font-leagueSpartan md:mb-12 sm:text-xl text-gray-400">Stay up to date with the roadmap progress, announcements and exclusive discounts feel free to sign up with your email.</p>
          <form action="#">
